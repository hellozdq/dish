<template>
  <div class="home">
   <header class="f_header">
      <x-header :left-options="{showBack: false}" title="主页">
      </x-header>
    </header>
    <main>
      ...
      <div class="right" ref="right">
         <ul>
            ...
            <ul>
              <li v-for="(item, key) in items.data" :key="key">
                <div class="card_l"><img :src="item.picUrl" alt=""/></div>
                <div class="card_r">
                  <div class="card_r_m">
...
<script>
  ...
  export default{
    ...
    created() {
       ...
       this.dishData.sort(compare('num'));
       let that=this;
